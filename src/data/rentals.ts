...
export const RENTAL_MODELS: RentalModel[] = [
  ...
  { id: "phantom",  name: "The Phantom",    tagline: "Matte black everything. Mysterious by design.",        height: "75cm", material: "Smoked glass + black anodized aluminum",  hoseType: "Single hose", dailyRate: 5800,  sessionRate: 3000,  available: 2, tier: "Premium",  accentColor: "#94a3b8" },
  ...
  { id: "street",   name: "The Street King",tagline: "Compact. Rugged. Urban energy.",                       height: "55cm", material: "Reinforced glass + powder-coated steel",  hoseType: "Single hose", dailyRate: 3500,  sessionRate: 1800,  available: 6, tier: "Standard", accentColor: "#ff6b35" },
